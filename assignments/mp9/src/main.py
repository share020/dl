...
def parse_args():
    ...
    # trainig command
    parser.add_argument('--option', type=str, default="option1", help='which part')
    ...
    parser.add_argument('--batch_size_train', type=int, default=16, help='training set input batch size')
    parser.add_argument('--batch_size_test', type=int, default=16, help='test set input batch size')
